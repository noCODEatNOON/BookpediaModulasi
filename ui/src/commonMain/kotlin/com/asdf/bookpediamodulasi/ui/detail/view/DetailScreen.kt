package com.asdf.bookpediamodulasi.ui.detail.view
...
import bookpediamodulasi.ui.generated.resources.description_unavailable
import bookpediamodulasi.ui.generated.resources.languages
import bookpediamodulasi.ui.generated.resources.pages
import bookpediamodulasi.ui.generated.resources.rating
import bookpediamodulasi.ui.generated.resources.synopsis
...
fun DetailScreen(
    ...
    DetailScreen(
        ...
        onAction = { action ->
            when(action) {
                is BookDetailCallback.OnBackClick -> onBackClick()
                else -> Unit
            }
...
private fun DetailScreen(
    ...
    onAction: (BookDetailCallback) -> Unit,
) {
    BlurredImageBackground(
        imageUrl = state.book?.imageUrl,
        isFavorite = state.isFavorite,
        onFavoriteClick = {
            onAction(BookDetailCallback.OnFavoriteClick)
        },
        onBackClick = {
            onAction(BookDetailCallback.OnBackClick)
        },
